...
build_order=("gateway" "observer" "core" "did-id-create" "wallet" "signature-verify" "template-verify" "claim-verify" "signature-create" "claim-create" "vc-revocation" "vc-create")
